  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold mb-6">FAQ, Rules & Regulations</h1>
        <div className="rounded-2xl border border-white/15 bg-white/5 p-6 min-h-[18rem]">
          <div className="text-gray-300">Place your FAQ and rules content here...</div>
        </div>
      </main>
    </div>
  );
